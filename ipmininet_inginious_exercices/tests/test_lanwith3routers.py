...
from exercices.lanwith3routers import LANWith3Routers
from ipmininet.ipnet import IPNet
from ipmininet.iptopo import IPTopo


@require_root
def test_LANWith3Routers():
    ...
    try:
        net = IPNet(topo=LANWith3Routers("4", subnet, prefixlen, gw) \
        ...
        net["h1"].cmd("ip route add default via 192.168.1.1")
        ...
        net["h2"].cmd("ip route add default via 192.168.2.1")
        
        
        
        itf5 = net["h3"].intf("h3-eth0")
        itf5.ip = "192.168.3.2/24"
        itf5.prefixLen == 24
        
        
        itf6 = net["r3"].intf("r3-eth0")
        itf6.ip = "192.168.3.1/24"
        itf6.prefixLen == 24
        
        net["h3"].cmd("ip route add default via 192.168.3.1")
        
        
        itf7 = net["r1"].intf("r1-eth1")
        itf7.ip = "192.168.4.1/24"
        itf7.prefixLen == 24
        
        
        
        itf8 = net["r2"].intf("r2-eth1")
        itf8.ip = "192.168.4.2/24"
        itf8.prefixLen == 24
        
        itf9 = net["r2"].intf("r2-eth2")
        itf9.ip = "192.168.5.1/24"
        itf9.prefixLen == 24
        
        itf10 = net["r3"].intf("r3-eth1")
        itf10.ip = "192.168.5.2/24"
        itf10.prefixLen == 24
        
        itf11 = net["r1"].intf("r1-eth2")
        itf11.ip = "192.168.6.1/24"
        itf11.prefixLen == 24
