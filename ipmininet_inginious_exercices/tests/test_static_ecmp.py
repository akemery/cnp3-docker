...
from exercices.static_ecmp import StaticECMPRouting
...
def test_StaticECMPRouting():
    ...
    try:
        ...
        net["R1"].cmd("ip route add 192.168.2.0/24 nexthop dev R1-eth1 via 192.168.3.2 nexthop  dev R1-eth2 via 192.168.6.2")
        ...
        net["R4"].cmd("ip route add 192.168.1.0/24 nexthop dev R4-eth2 via 192.168.5.1 nexthop dev R4-eth1 via 192.168.4.1")
